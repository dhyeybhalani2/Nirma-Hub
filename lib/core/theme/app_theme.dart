...
class AppColors extends ThemeExtension<AppColors> {
  ...
  /// Luxury black night palette. The canvas is true black; cards sit only a
  /// shade above it and are defined by a crisp hairline rather than by being
  /// noticeably lighter, which is what separates a black theme from a grey
  /// one. Lightness is spent where it earns attention: raised controls
  /// (`hero`) and near-white type.
  static const AppColors dark = AppColors(
    isDark: true,
    bg: Color(0xFF000000),
    card: Color(0xFF101013),
    fill: Color(0xFF08080A),
    fillStrong: Color(0xFF1B1B1F),
    border: Color(0xFF2B2B30),
    borderStrong: Color(0xFF3E3E45),
    text: Color(0xFFFFFFFF),
    textSoft: Color(0xFFF2F2F4),
    textSecondary: Color(0xFFCACAD0),
    textMuted: Color(0xFF9B9BA2),
    textFaint: Color(0xFF6F6F77),
    accent: Color(0xFFFF6B66),
    accentFill: Color(0xFFC62828),
    accentSoft: Color(0xFF241012),
    accentSoftBorder: Color(0xFF4E1F24),
    hero: Color(0xFF2C2C31),
    heroBorder: Color(0xFF42424A),
    solid: Color(0xFFFFFFFF),
    onSolid: Color(0xFF000000),
    success: Color(0xFF34D399),
    successFill: Color(0xFF0C7E5A),
    successSoft: Color(0xFF0B241D),
    successBorder: Color(0xFF174A39),
    warning: Color(0xFFFBBF24),
    warningText: Color(0xFFFCD34D),
    warningSoft: Color(0xFF261D0E),
    warningBorder: Color(0xFF55400F),
    danger: Color(0xFFFB7A7A),
    dangerFill: Color(0xFFB5342B),
    dangerSoft: Color(0xFF281315),
    dangerBorder: Color(0xFF552025),
    info: Color(0xFF60A5FA),
    infoFill: Color(0xFF1D4ED8),
    infoSoft: Color(0xFF0D1829),
    infoBorder: Color(0xFF1B3560),
    purple: Color(0xFFD8B4FE),
    purpleSoft: Color(0xFF1E1430),
    purpleBorder: Color(0xFF452871),
...
class AppTheme {
  ...
  static ThemeData _build(AppColors c, Brightness brightness) {
    ...
    final scheme = ColorScheme.fromSeed(
      ...
      surfaceContainerHigh: isDark ? const Color(0xFF1B1B1F) : const Color(0xFFE2E8F0),
      surfaceContainerHighest: isDark ? const Color(0xFF2B2B30) : const Color(0xFFCBD5E1),
