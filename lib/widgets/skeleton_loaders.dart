...
class PyqListSkeleton extends StatefulWidget {
  const PyqListSkeleton({super.key});

  @override
  State<PyqListSkeleton> createState() => _PyqListSkeletonState();
}

class _PyqListSkeletonState extends State<PyqListSkeleton> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
...
class SgpaSkeleton extends StatefulWidget {
  const SgpaSkeleton({super.key});

  @override
  State<SgpaSkeleton> createState() => _SgpaSkeletonState();
}

class _SgpaSkeletonState extends State<SgpaSkeleton> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
      ...
      builder: (context, child) {
        return Opacity(
          ...
          child: ListView(
            ...
            children: [
              // Dashboard header card skeleton
              Container(
...
class NotificationSettingsSkeleton extends StatefulWidget {
  const NotificationSettingsSkeleton({super.key});

  @override
  State<NotificationSettingsSkeleton> createState() => _NotificationSettingsSkeletonState();
}

class _NotificationSettingsSkeletonState extends State<NotificationSettingsSkeleton>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: _controller,
      builder: (context, child) {
        final placeholderColor = Theme.of(context).colorScheme.outlineVariant;
        final cardColor = Theme.of(context).colorScheme.surface;
        final borderColor = Theme.of(context).colorScheme.outlineVariant.withValues(alpha: 0.5);
        ...
        return Opacity(
          ...
          child: ListView(
            ...
            children: [
                        ...
                        children: [
                          ...
                          FractionallySizedBox(
                            ...
                            child: Container(
                              height: 12,
                              decoration: BoxDecoration(
                                color: placeholderColor.withValues(alpha: 0.7),
                                borderRadius: BorderRadius.circular(4),
                              ),
                            ),
                          ),
              ...
              // 3. First Class Timing Card Skeleton
              Container(
              ...
              // 5. Subsequent Class Timing Card Skeleton
              Container(
                padding: const EdgeInsets.all(18),
                decoration: BoxDecoration(
                  color: cardColor,
              ...
              // 7. Alert Preferences Card Skeleton
              Container(
